...
Models are the "brains", tokens are the currency, context is the memory, prompts are the steering wheel, and the loop is what makes it an agent. Everything else you will pick up by getting your hands dirty, which is exactly what we suggest you go and do. If you have not set up a tool yet, our [installation guide](/guides/installing-an-agentic-coding-platform) will get you there in ten minutes.
