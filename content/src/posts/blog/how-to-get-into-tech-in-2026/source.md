---
title: "How to get into tech in 2026"
excerpt: "For 30 years, code was the gatekeeper into tech. Now that LLMs write it for you, the route in has changed. Here's how to actually get into tech in 2026."
tags: ["jiki", "learn-to-code", "llms", "beginners", "careers"]
seo:
  description: "Code used to be the gatekeeper into tech. In 2026, LLMs write the code and your value is knowing how to build things properly. Here's how to get into tech."
  keywords:
...
In 5 years, **no-one will be hiring you for your coding skills.** They're irrelevant. I have barely written a line of code in the last year, but through Claude, I've output hundreds of thousands of lines of code. And they work. They sit together in a coherent manner and power platforms like [Jiki](https://jiki.io) and have solved countless bugs in [Exercism](https://exercism.org), [Kaido](https://kaido.org) and [Giki](https://gikiactions.com). But they only do that because I know what I'm doing. Without the guidance of a human, they would not have got here.

A developer's value is not in their ability to write code ([although you still need to know how!](/blog/should-i-still-learn-to-code-in-2026)). It's in their **ability to make things properly**.
...
And [Jiki](https://jiki.io) will teach you the first part. Follow our Learn to Code course to get the coding basics down properly, so that when you move on to building things with an LLM you understand what it is doing. **And have a ton of fun on the way.**
