...
excerpt: "How we expect everyone in the Jiki community to behave."
tags: ["legal"]
seo:
  description: "Code of Conduct for Jiki - the standards of behaviour we expect from everyone in our community."
  keywords: ["jiki", "code of conduct", "community", "safety"]
---

## Introduction

Jiki is a platform centered around empathetic conversation. We have a low tolerance for communication that makes anyone feel unwelcome, unsupported, insulted or discriminated against.

## Seen or experienced something uncomfortable?

If you see or experience abuse, harassment, discrimination, or feel unsafe or upset, please email abuse@jiki.io. We will take your report seriously.
...
Jiki should be a safe place for everybody regardless of
...
_This policy is a "living" document, and subject to refinement and expansion in the future. This policy applies to the Jiki website, the Jiki GitHub organization, any other Jiki-related communication channels (e.g. Forum, Slack, Twitter, email) and any other Jiki Ltd entity or event._
