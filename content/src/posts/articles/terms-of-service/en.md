...
excerpt: "The terms and conditions governing your use of the Jiki platform."
tags: ["legal"]
seo:
  description: "Terms of Service for Jiki - the terms and conditions governing your use of our learn-to-code platform."
  keywords: ["jiki", "terms of service", "legal", "terms and conditions"]
---
...
Jiki is run and managed by Jiki Ltd, a company registered in the UK.
The following Terms of Service (these **Terms**) are an agreement between **Jiki Ltd** and you, and govern your permitted use of our **Platform**.

You might also want to read:

- Our [Privacy Policy](/articles/privacy-policy)
- Our [Accessibility Statement](/articles/accessibility)
...
4. We want to make Jiki an enjoyable and safe place for everyone and we will take action against users who undermine our Platform and/or our community values.
5. The content you submit to the Platform such as code solutions are published openly under an open license.
...
Jiki is run and managed by Jiki Ltd ("We", "Us"), a company registered in the UK.
The following Terms of Service (these **Terms**) are an agreement between **Jiki Ltd** and you, and governs your permitted use of our **Platform**.
...
We reserve the right to modify these Terms at any time by posting revised Terms on https://jiki.dev. These Terms apply to all who access or use our Platform, registered or otherwise.

Any personal information submitted to our Platform is subject to our [Privacy Policy](/articles/privacy-policy).

### Definitions

- Exercise(s) - a coding exercise on Jiki, designed to teach programming concepts.
- Solution(s) - code that is submitted by our Users as a solution to an exercise.
- User(s) - any user of the Jiki Platform, whether signed up or not.
...
- your use of our services is consistent with these Terms of Service and our Privacy Policy.

When using our Platform, you AGREE NOT TO:

- share or upload defamatory, libelous, or inaccurate content.
- share or upload any content that is unlawful.
- share or upload content that a reasonable person could deem to be objectionable, offensive, distressing, or otherwise inappropriate.
...
- make unsolicited offers and advertisements to other Users of the Platform.
...
It is expected that such removals will be governed by these Terms of Service.
...
Jiki Ltd reserves the right to refuse, suspend or terminate - without notice - your access to the Platform if it determines, in its sole discretion, that you have in any way violated these Terms of Service.

### Content Permissions and Licensing

Content delivered through our Platform may be owned by us (Our Content), contributed by our wider community (Community Content), or be contributed by users like You (User Contributed Content).
...
All materials displayed on our Website and/or Platform are Copyright **Jiki Ltd**.
...
The exercises delivered through the platform have been built by a community of contributors and are licensed mainly under the MIT License.
All of this content is available directly through our GitHub repositories where specific license details can be viewed.

#### User Contributed Content

The primary purpose of the Platform is to provide a space where individuals can solve programming (coding) challenges and learn to code.

When you use our Platform, you will be presented with exercises for you to solve, and be invited to submit your **Solution** for evaluation.

You agree that all content (**User Contributed Content**) that you have previously uploaded, or subsequently upload, to the Platform will be licensed to Jiki Ltd on worldwide, royalty-free, non-exclusive, perpetual basis.
You grant Jiki Ltd the perpetual and irrevocable right and license to process, copy, distribute and to commercially exploit all such User Contributed Content that you contribute.
...
Using our right to license the content, we will distribute your User Contributed Content under the terms of the [Creative Commons BY-NC-SA license](https://creativecommons.org/licenses/by-nc-sa/4.0/).
This means that any third parties using or adapting your content should attribute Jiki as the source.

It is your responsibility to ensure that the content you upload to the Platform is compatible with the CC BY-NC-SA license and includes any appropriate attribution. This agreement means that you cannot revoke permission for us to use any content you upload.
...
- Improving the user-experience of jiki.dev
- Using anonymized solutions to build educational tools
- Performing data analysis to improve our teaching methods
...
- Because you grant us an **irrevocable, royalty-free, commercial** license on your User Contributed Content, we are allowed to re-use and adapt this content.
  We will do this in ways aligned with our mission.
- Because we present your User Contributed Content under a CC BY-NC-SA license, others can use and benefit from that content, but they have to credit our Platform (jiki.dev) when they do, and may not use it for commercial purposes.
...
When you delete your account, we erase all the personal details from your account. This is an irreversible process, so please be sure before you delete your account. Your solutions will still remain on the Platform but will be anonymized.
...
To the maximum extent allowed by law, Jiki Ltd disclaims all warranties and representations of any kind, including without limitation the implied warranties of fitness for a particular purpose, and non-infringement, whether express, implied, or statutory.
...
Within our Platform we invite you to configure your notification preferences describing what and when you would like us to contact you about.
