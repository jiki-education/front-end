...
import huMessages from "@javascript/locales/hu/translation.json";
import frMessages from "@javascript/locales/fr/translation.json";
import ukMessages from "@javascript/locales/uk/translation.json";
...
describe("ordinal iteration descriptions", () => {
  ...
  test("Hungarian uses the Hungarian ordinal form, never an English suffix", () => {
    const descriptions = iterationDescriptions(tagLocale("hu", huMessages as Messages));
  ...
  test("French distinguishes 1re from 2e, which English rules cannot express", () => {
    const descriptions = iterationDescriptions(tagLocale("fr", frMessages as Messages));
  ...
  test("Ukrainian reads the numeral as a cardinal, by choice", () => {
    ...
    const descriptions = iterationDescriptions(tagLocale("uk", ukMessages as Messages));
  ...
  test("a dict that does not name its locale is not silently rendered with English rules", () => {
    ...
    const descriptions = iterationDescriptions(huMessages as Messages);
