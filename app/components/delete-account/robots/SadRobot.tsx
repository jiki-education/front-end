  ...
  return (
    <div className={styles.robotContainer}>
      <svg className={styles.robot} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="100" cy="140" r="6" fill="var(--color-gray-400)">
          <animate attributeName="opacity" values="0.3;0.6;0.3" dur="2s" repeatCount="indefinite" />
        </circle>

        {/* Left arm - down */}
        <rect className={styles.body} x="30" y="125" width="20" height="35" rx="6" />

        {/* Right arm - raised up waving */}
        <g className={styles.waveHand}>
          <rect className={styles.body} x="154" y="103" width="18" height="30" rx="6" transform="rotate(45 163 118)" />
        </g>
      </svg>
    </div>
  );
