...
/**
 * Dynamically imports an exercise icon SVG component from the curriculum package.
 *
 * Uses React.lazy() for code splitting - each icon is loaded on demand.
 * Webpack creates a context module that bundles all SVGs in the exercises directory.
 ...
 */
function getExerciseIcon(exerciseSlug: string): ComponentType<SVGProps<SVGSVGElement>> {
  return lazy(() =>
    import(`../icons/exercises/${exerciseSlug}.svg`).catch(() => {
