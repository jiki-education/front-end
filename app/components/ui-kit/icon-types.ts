...
export type IconName = "account-settings" | "all" | "bootcamp-cross-red" | "bootcamp-tick-green" | "bug" | "chat" | "chevron-right" | "coding" | "complete" | "danger-settings" | "email" | "file" | "folder" | "functions" | "globe" | "google" | "hamburger" | "hint" | "house" | "in-progress" | "instructions" | "jiki-logo" | "jiki-logo-collapsed" | "learning-settings" | "locked" | "log" | "medal" | "notifications-settings" | "open-book" | "password" | "play" | "privacy-settings" | "projects" | "quiz" | "readonly-lock" | "search" | "settings" | "subconcept" | "vercel" | "video" | "window";
