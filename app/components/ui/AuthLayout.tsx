    ...
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-15 py-15 text-white bg-gradient-to-br from-[#3b82f6] via-[#2563eb] to-[#667eea] min-h-[300px] lg:h-screen lg:sticky lg:top-0 overflow-hidden">
        <div className="text-center z-10">
          <div
            className="text-5xl lg:text-7xl font-medium mb-10 leading-none"
            style={{ textShadow: "0 4px 20px rgba(0,0,0,0.2)" }}
          >
            Jiki
          </div>
          <h1 className="text-xl lg:text-3xl font-medium mb-5 leading-tight max-w-lg" style={{ textWrap: "balance" }}>
            Your coding journey starts here
          </h1>
          <p className="text-base lg:text-lg opacity-95 max-w-md leading-relaxed mb-14" style={{ textWrap: "balance" }}>
            Join millions of learners transforming their careers through hands-on coding practice.
          </p>

          <div className="text-center">
            <div className="text-xs text-white/40 uppercase tracking-wider mb-2">Created By</div>
