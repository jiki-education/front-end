...
description: "Modificare il contenuto di una variabile durante l'esecuzione del programma per tenere traccia di posizioni, conteggi, punteggi e altri valori che cambiano."
