...
en_md5: ec004465cfbba62acf0cc6f973e27e97
---
...
Kezdjük is az egyik alapvető programozási fogalommal, a függvényekkel (function). A függvények olyanok, mint kis gépek, amelyeket Jiki a te utasításodra használ. Ha benézünk Jiki raktárába, ő ott szokott tanyázni, látni fogod, hogy van egy polca három különböző géppel: move, turn left és turn right.
...
Amikor leírtad, hogy turn left, majd a zárójeleket, azzal arra utasítottad Jikit, hogy vegye le a turn left gépet a polcról, és használja azt. Ezt a mintát fogod újra és újra használni. Amikor egy gépet szeretnél használni, leírod a nevét, utána a zárójeleket, és ezzel mondod meg Jikinek, hogy hozza el a gépet, és használja:
