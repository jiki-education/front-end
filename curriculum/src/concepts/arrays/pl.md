---
title: "Tablice"
description: "Uporządkowany łańcuch elementów (stringów, liczb, wartości logicznych lub czegokolwiek innego), połączonych w jedną wartość, którą Jiki może się posługiwać."
