---
title: "Arrays"
description: "Una cadena ordenada de elementos (strings, números, Booleans o cualquier otra cosa) que se mantienen unidos como un solo valor que Jiki puede pasar de un lado a otro."
...
Es un tipo de dato que puede contener varias cosas, no solo una, y este tipo de dato se llama arreglo (_array_ en inglés). Cuando escuchas la palabra array, quiero que pienses en una cadena física que mantiene juntas un montón de cosas.
