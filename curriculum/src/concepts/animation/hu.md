...
Vegyünk egy ismerős kódrészletet, amelyben köröket rajzolunk a képernyőre: beállítunk egy position nevű változót (variable), és van egy `repeat` blokkunk, amelyben rajzolunk egy kört, majd a pozíciót eggyel jobbra toljuk. Ha ezt a `repeat` blokkot 100-szor futtatjuk le, 100 kört fogunk látni a képernyőn.
