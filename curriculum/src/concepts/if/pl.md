...
description: "Jak za pomocą słowa kluczowego `if` uruchomić blok kodu tylko wtedy, gdy warunek jest prawdziwy, zupełnie jak bramkarz wpuszczający gości do środka."
