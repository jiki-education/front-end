...
Create a function called <define>`drawWeather(elements)`</define> that takes a <define>list</define> of weather elements and draws the corresponding scene.
...
- If there's NO cloud in the elements, draw a **large sun**: <define>`circle(50, 50, 25, "#ffed06")`</define>
- If there IS a cloud, draw a **small sun**: `circle(75, 30, 15, "#ffed06")`

**Cloud** is made of:

- <define>`rectangle(25, 50, 50, 10, "#FFFFFF")`</define>
...
- <define>`ellipse(30, 70, 3, 5, "#56AEFF")`</define>
...
- `circle(centerX, centerY, radius, color)` -- draws a circle
- `ellipse(centerX, centerY, radiusX, radiusY, color)` -- draws an ellipse
