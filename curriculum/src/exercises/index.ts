...
export const exercises = {
  ...
  "owners-bouquets": () => import("./owners-bouquets"),
  "wordle-process-guess": () => import("./wordle-process-guess"),
  "wordle-process-game": () => import("./wordle-process-game"),
  ...
  "weather-symbols": () => import("./weather-symbols"),
