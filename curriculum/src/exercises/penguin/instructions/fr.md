...
On a déjà dessiné la moitié de l'image pour toi. En lisant le code qui s'y trouve, tu devrais pouvoir déduire les autres valeurs pour rendre le dessin symétrique. Rappelle-toi : le coin supérieur gauche du canvas est `0,0`, et le coin inférieur droit est `100,100`. Le pingouin est assis au milieu. Pour le nez, tu dois **modifier** les coordonnées du milieu du triangle. N'ajoute pas de nouveau triangle.
