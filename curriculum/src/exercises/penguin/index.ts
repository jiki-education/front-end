...
const functions: FunctionInfo[] = [
  {
    ...
    examples: ["rectangle(0, 0, 100, 50)", "rectangle(10, 20, 50, 30)"],
  ...
  },
  {
    ...
    examples: ["triangle(50, 20, 40, 40, 60, 40)", "triangle(10, 10, 20, 10, 15, 20)"],
    category: "Drawing Shapes"
  },
  {
    name: "fill_color_hex",
    ...
    examples: ['fill_color_hex("#FF0000")', 'fill_color_hex("#ADD8E6")', 'fill_color_hex("#FFA500")'],
    category: "Colors"
  }
];
