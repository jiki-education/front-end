...
In addition to your existing helper function (which we suggested you called `includes`), we recommend you create two new helper functions to help you solve this. The functions have standard names, which we recommend sticking to:
