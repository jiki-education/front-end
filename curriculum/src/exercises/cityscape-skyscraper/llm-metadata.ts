...
export const llmMetadata: LLMMetadata = {
  description: `
    ...
    with loops. Students build a skyscraper by calling numFloors() to determine height,
  ...
  tasks: {
    "build-skyscraper": {
      description: `
        Students need to:
        1. Call numFloors() and store the result, subtract 1 for upper floors
        ...
        - Show how numFloors() returns a value you can store and use
        - Demonstrate a loop for upper floors
