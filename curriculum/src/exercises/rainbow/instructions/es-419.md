...
El arcoíris está formado por `100` barras, cada una de arriba a abajo con un ancho de `1`. La primera barra debe tener un `x` (coordenada horizontal) de `0`, y la barra final debe tener un `x` de `99`.
