...
- Hai una variabile già scritta `snowmanX` (coordinata X del centro dell'immagine) per il centro dell'immagine e una variabile `size` che puoi cambiare da `1` a `5` per far crescere il pupazzo di neve.
...
- I cerchi devono toccarsi: il corpo si trova direttamente sopra la base e la testa si trova direttamente sopra il corpo. (Il nostro pupazzo di neve è un po' più precario rispetto agli esercizi precedenti: ogni palla di neve è posizionata esattamente sopra quella sottostante senza che si fondano l'una nell'altra. Dev'essere una giornata molto gelida!)
