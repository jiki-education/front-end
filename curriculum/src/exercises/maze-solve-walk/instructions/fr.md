...
Nous revoilà dans le labyrinthe ! La dernière fois, tu as utilisé la fonction `move()` (« se déplacer ») pour avancer d'un pas à la fois. Ça fonctionnait, mais écrire `move()` plein de fois d'affilée devient vite fastidieux !
