...
Nell'ultimo livello, hai capito come spostare un cannone laser avanti e indietro, colpendo gli alieni. Abbiamo portato qui la soluzione per continuare.
...
Crea la funzione `shootIfAlienAbove`, quindi usala all'interno del ciclo insieme alla logica di movimento.
