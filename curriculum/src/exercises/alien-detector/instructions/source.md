...
2. When you've shot them all down, you should immediately use <define>`fireFireworks()`</define>. This **must** happen in the same loop iteration as shooting the final alien.
