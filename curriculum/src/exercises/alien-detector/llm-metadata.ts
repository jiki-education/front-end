...
export const llmMetadata: LLMMetadata = {
  description: `
    There is no isAlienAbove() helper, so the student must build their own model of the world from
    getStartingAliensInRow() and keep it in sync as they shoot. Anchor steps:
