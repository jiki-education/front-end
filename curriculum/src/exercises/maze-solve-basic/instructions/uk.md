...
Ліворуч видно, що перші три вказівки ми вже написали. Почнімо з натискання кнопки **«Запустити код»**, щоб побачити, що вони роблять. А потім **додаймо ще вказівок**, щоб довести чоловічка до кінця лабіринту. Пишемо по одній вказівці в кожному рядку, а потім натискаємо **Запустити код**, щоб виконати їх усі.
