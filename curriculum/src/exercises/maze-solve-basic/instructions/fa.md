...
description: "با دستورهای ساده، جیکی را در هزارتو راهنمایی کنید."
en_md5: bbd838559fba4dcf527a55ba135703cd
---

به اولین تمرین‌تان خوش آمدید!

هدف تمرین این است که با نحوه‌ی کار محیط یادگیری آشنا شوید. کار شما این است که با دادن دستور به آدمک، هزارتویی را که در سمت چپ می‌بینید حل کنید. همه‌ی دستورهایی را که آدمک باید دنبال کند می‌نویسید، بعد روی **«اجرای کد»** کلیک می‌کنید تا آن‌ها را انجام دهد.
