...
In this first part, take a weather description (like `sunny` or `rainbow-territory`) and turn it into a <define>list</define> of the components that need drawing.
...
Create a function called <define>`descriptionToElements(description)`</define>. It takes the description as a string input and returns the list of components to draw.
