...
export const llmMetadata: LLMMetadata = {
  description: `
    ...
    function since built-in length is not available. The bouncer/party
    framing provides a fun visual context for the string comparison logic.
  `,
  ...
  tasks: {
    "check-the-name": {
      description: `
        Students need to:
        1. Call ask_name() and get_allowed_start() to get the two strings
        2. Write a get_length helper function (iterate through string, count characters)
        3. Write a starts_with helper function that:
        ...
        4. Use the result to call let_in() or turn_away()

        Key concepts:
        - Building utility functions from scratch (get_length, starts_with)
        ...
        - Off-by-one errors with counter variables (Jiki is 1-indexed)
